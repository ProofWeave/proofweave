...
4. domain: 데이터 주제에 가장 적합한 분류를 선택.
   defi/smart_contract/nft/dao/infrastructure/blockchain/
   cryptocurrency/security/ai_ml/data_science/web3/
   economics/education/health/science/technology/general 중 하나.
5. problemType: 분석 유형에 가장 적합한 분류를 선택.
   security_analysis/code_review/summarization/translation/
   data_analysis/code_generation/research/comparison/
   tutorial/opinion/troubleshooting/general 중 하나.
